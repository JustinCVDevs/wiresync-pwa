...
export interface TrainArrival extends BaseRecord {
    id: string;
	trainId?: string;
	portRailArrivalTimestamp?: Date; // PORT_RAIL_ARRIVAL_TIMESTAMP
	portStagingTimestamp?: Date; // PORT_STAGING_TIMESTAMP
	finishSamplingTimestamp?: Date; // FINISH_SAMPLING_TIMESTAMP
