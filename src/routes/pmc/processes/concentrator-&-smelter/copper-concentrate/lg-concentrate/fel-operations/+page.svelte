	...
	async function handleSubmit() {
		try {
			...
			if (selectedTruck) {
				...
				goto(`/pmc/processes/concentrator-&-smelter/copper-concentrate/lg-concentrate/fel-operations/verification?truckRegistration=${encodeURIComponent(truck?.registration || '')}`);
			}
