<script lang="ts">
	...
	async function handleSubmit() {
		try {
			...
			goto(`/pmc/processes/concentrator-&-smelter/copper-concentrate/lg-concentrate/sampling/verification?sampleId=${encodeURIComponent(sampleId)}&truckRegistration=${encodeURIComponent(truckRegistration)}`)
		} catch (err) {
