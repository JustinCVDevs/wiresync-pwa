	...
	const processes = [
		{
			...
			href: '/pmc/processes/concentrator-&-smelter/copper-concentrate/hg-concentrate/sampling'
		},
		{
			name: 'FEL Operations',
			icon: ArrowRightCircle,
			color: 'text-green-500',
			href: '/pmc/processes/concentrator-&-smelter/copper-concentrate/hg-concentrate/fel-operations'
		}
	] as const;
