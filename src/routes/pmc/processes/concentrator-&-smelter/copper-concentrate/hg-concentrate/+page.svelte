<script lang="ts">
	...
	async function handleSubmit() {
	  try {
		...
		goto(`/pmc/processes/concentrator-&-smelter/copper-concentrate/hg-concentrate/verification?truckLoadId=${truckLoadId}&assayId=${assay.id}`);
	} catch (err) {
