	...
	const processes = [
		{
			...
			href: '/pmc/processes/concentrator-&-smelter/unrefined-copper/reverts/sampling'
		},
		{
			name: 'FEL Operations',
			icon: ArrowRightCircle,
			color: 'text-green-500',
			href: '/pmc/processes/concentrator-&-smelter/unrefined-copper/reverts/fel-operations'
		}
	] as const;
