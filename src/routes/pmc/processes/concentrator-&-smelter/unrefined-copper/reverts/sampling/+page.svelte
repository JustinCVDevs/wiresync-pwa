<script lang="ts">
	...
	async function handleSubmit() {
		try {
			...
			goto(`/pmc/processes/concentrator-&-smelter/unrefined-copper/reverts/sampling/verification?sampleId=${encodeURIComponent(sampleId)}&truckRegistration=${encodeURIComponent(truckRegistration)}`)
		} catch (err) {
