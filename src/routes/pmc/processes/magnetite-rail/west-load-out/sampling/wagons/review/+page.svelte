<script lang="ts">
	...
	async function handleNewWagon() {
		...
		if (unweighedWagons.length === 0) {
			...
			goto(`/pmc/processes/magnetite-rail/west-load-out/sampling/wagons/?wagonIdSimple=${wagonIdSimple.join(',')}&shuntingTrainVerificationDate=${shuntingTrainVerificationDate}`);
		}
	}
...
<ProcessLayout
	...
	cancelPath="/pmc/processes/magnetite-rail/west-load-out/sampling"
