	...
	const processes = [
		{
			...
			href: '/pmc/processes/magnetite-road/truck-load-out/sampling'
		},
		{
			name: 'FEL Operations',
			icon: ArrowRightCircle,
			color: 'text-green-500',
			href: '/pmc/processes/magnetite-road/truck-load-out/fel-operations'
		}
	] as const;
...
<section class="space-y-4 px-4">
	...
	<button
		on:click={() => goto('/pmc/processes/magnetite-road')}
