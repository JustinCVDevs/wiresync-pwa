	...
	{:else}
		...
		{:else}
			<div class="flex items-center justify-between">
				<button
					class="bg-gray mb-4 mr-1 w-full rounded-md py-3 text-sm text-white hover:bg-blue-700"
					on:click={() => {
						currentStep = 2;
						showWagonInput = true;
					}}
				...
				<button
					class="bg-gray mb-4 ml-1 w-full rounded-md py-3 text-sm text-white hover:bg-blue-700"
					on:click={() => {
