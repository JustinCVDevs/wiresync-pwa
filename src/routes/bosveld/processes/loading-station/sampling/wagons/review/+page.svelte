					...
					{#each filteredWagons as wagon}
						<div class="flex flex-col">
							...
							<div
								...
								on:click={() => goto(`/bosveld/processes/loading-station/sampling/wagons?wagonIdSimple=${wagon.wagonIdSimple}&shuntingTrainIds=${shuntingTrainIds.join(',')}&wagonIds=${linkedWagonIds.join(',')}`)}
							>
